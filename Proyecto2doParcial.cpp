...
do
{	
cout<<"I.Capturar letras alternadas en mayusculas y minusculas mediante una funcion Recursiva y las imprima en forma inversa (captura a regresa A, captura A regresa a)"<<endl;
cout<<"II.Capturar caracteres hasta que aparezca un numero imprima los caracteres"<<endl;
cout<<"III.Capture 2 valores (0 o 1) y aplique el operador and con ellos e indique si la operacion es verdadera o falsa"<<endl;
cout<<"IV.Capture 12 letras e imprimir 3 por renglon 1er renglon a,b,c 2do renglon r,d,e etc"<<endl;
cout<<"V.Capture dos caracteres mediante una plantilla sumarlos, como enteros y como caracteres"<<endl;
cout<<"VI.Salir"<<endl;
